<?php
namespace Opencart\Admin\Controller\Extension\Cashfree\Payment;

class Cashfree extends \Opencart\System\Engine\Controller {
    private array $error = [];

    public function index(): void {
        $this->load->language('extension/cashfree/payment/cashfree');
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('extension/cashfree/payment/cashfree', 'user_token=' . $this->session->data['user_token'])
        ];

        $data['save'] = $this->url->link('extension/cashfree/payment/cashfree.save', 'user_token=' . $this->session->data['user_token']);
        ...
        $this->response->setOutput($this->load->view('extension/cashfree/payment/cashfree', $data));
    }
    ...
    public function save(): void {
        ...
        if (!$this->user->hasPermission('modify', 'extension/cashfree/payment/cashfree')) {
