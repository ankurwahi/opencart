<?php
namespace Opencart\Catalog\Controller\Extension\Cashfree\Payment;
class Cashfree extends \Opencart\System\Engine\Controller
{
    ...
    public function index()
    {
        ...
        return $this->load->view('extension/cashfree/payment/cashfree', [
    ...
    private function prepareOrderRequest($order_info) {
        ...
        return [
            ...
            "order_meta" => [
                "return_url" => $this->url->link('extension/cashfree/payment/cashfree.thankyou', 'order_id=' .$order_id, true),
                "notify_url" => $this->url->link('extension/cashfree/payment/cashfree.callback', '', true)
            ],
    ...
    {
        $this->load->model('checkout/order');
        $this->language->load('extension/cashfree/payment/cashfree');
